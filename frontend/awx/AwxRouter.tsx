...
import { TemplatePromptLauncher } from './resources/templates/TemplatePromptLauncher/TemplatePromptLauncher';
  ...
  return (
    ...
    >
      <Routes>
        ...
        <Route
          path={RouteObjWithoutPrefix.JobTemplatePrompt}
          element={<TemplatePromptLauncher />}
        />
        <Route
