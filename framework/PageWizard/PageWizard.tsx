/**
 * PageWizard - Creates a complex form split into steps.
 *
 * @description - How to use:
 *  1. Define component types in constants file (ex. componentTypes.tsx)
 *  2. Define componentMapper to associate types from constants to form components (componentMapper.tsx)
 *  3. Define schema with steps, form fields, and other properties (example useTemplateSchema.tsx)
 *  4. Pass schema, initial values, event handlers to PageWizard component
 *  5. Using the schema, PageWizard will render a multi-step form and save form values in PageWizardProvider
 */
...
import type { LaunchPrompt } from '../../frontend/awx/resources/templates/TemplatePromptLauncher/TemplatePromptLauncher';
